...
{
	// Дерево с итератором
	AVL_Tree<string, Laptop> tree;

	tree.push("asus", Laptop("ASUS", "Vivobook", "Intel Core i7", "SSD", 15, 4, 16, 512, 1200));
    tree.push("dell", Laptop("Dell", "Inspiron", "AMD Ryzen 5", "HDD", 14, 6, 8, 256, 800));
    tree.push("hp", Laptop("HP", "Pavilion", "Intel Core i5", "SSD", 13, 2, 12, 256, 1000));
    tree.push("lenovo", Laptop("Lenovo", "ThinkPad", "Intel Core i9", "SSD", 15, 8, 32, 1, 2000));
    tree.push("acer", Laptop("Acer", "Aspire", "AMD Ryzen 7", "HDD", 17, 6, 16, 1, 1500));
    tree.push("apple", Laptop("Apple", "MacBook Pro", "Apple M1", "SSD", 13, 8, 16, 512, 2500));

	// Вывод по порядку
	for (AVL_Tree<string, Laptop>::Iterator it = tree.begin(); it != tree.end(); it++)
		cout << (*it).getValue() << endl;

	Laptop found = (*tree.find("lenovo")).getValue();

	// Расширяющиеся дерево (элементы с одинаковыми ключами хранятся справа)
	Splay_Tree<string, Laptop> stree;

	stree.push("asus", Laptop("ASUS", "Vivobook", "Intel Core i7", "SSD", 15, 4, 16, 512, 1200));
    stree.push("dell", Laptop("Dell", "Inspiron", "AMD Ryzen 5", "HDD", 14, 6, 8, 256, 800));
    AVL_Tree<string, Laptop>::Iterator it = stree.push("hp", Laptop("HP", "Pavilion", "Intel Core i5", "SSD", 13, 2, 12, 256, 1000));
    stree.push("lenovo", Laptop("Lenovo", "ThinkPad", "Intel Core i9", "SSD", 15, 8, 32, 1, 2000));
    stree.push("acer", Laptop("Acer", "Aspire", "AMD Ryzen 7", "HDD", 17, 6, 16, 1, 1500));
    stree.push("apple", Laptop("Apple", "MacBook Pro", "Apple M1", "SSD", 13, 8, 16, 512, 2500));
	...
	mtree.pushSingle(51, "123");
	mtree.pushSingle(51, "321");
	mtree.pushSingle(51, "TEST");

	mtree.pushSingle(12, "LOL");

	Stack<string> elems = mtree[51];

	cout << elems << endl; // "123", "321", "TEST"
